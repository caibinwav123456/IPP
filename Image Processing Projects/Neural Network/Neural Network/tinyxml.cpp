...
/*
函数描述：向缓冲区输出XML格式化的字符串
输入参数：
strBuffer  缓冲区
uiDepth    成员深度
返回值  ：  true 成功     false 失败
修改    ：  leichen 1503  2009-12-27
*/
bool TiXmlElement::ToXMLText( TIXML_STRING& strBuffer )
{
    strBuffer += "<";
    strBuffer += value;
    ...
    {
        strBuffer += ">" ;
        firstChild->ToXMLText( strBuffer );
        strBuffer += "</" ;
        strBuffer += value;
        strBuffer += ">" ;
    }
...
void TiXmlElement::SetText(const char* strTxt)
{
	TiXmlText xmlTxt(strTxt);
	TiXmlNode* pChild = FirstChild();
	if (NULL != pChild)
	{
		ReplaceChild(pChild, xmlTxt);
	}
	else
	{
		InsertEndChild(xmlTxt);
	}
}
...
修改    ：  leichen 1503  2009-12-27
*/
bool TiXmlDocument::ToXMLText( TIXML_STRING& strBuffer )
{
    TiXmlNode* node;
    for ( node=FirstChild(); node; node = node->NextSibling() )
    {
        if ( false == node->ToXMLText( strBuffer ))
        {
            return false;
        }
    }
...
修改    ：leichen 1503  2009-12-27
*/
bool TiXmlAttribute::ToXMLText( TIXML_STRING& strBuffer)
{
    if (value.find ('\"') == TIXML_STRING::npos)
    {
        strBuffer += " ";
...
修改    ：  leichen 1503  2009-12-27
*/
bool TiXmlComment::ToXMLText( TIXML_STRING& strBuffer )
{
    strBuffer += "<!--";
    strBuffer += value;
    strBuffer += "-->";
...
修改    ：  leichen 1503  2009-12-27
*/
bool TiXmlText::ToXMLText( TIXML_STRING& strBuffer )
{
    if ( cdata )
    {
        strBuffer += "<![CDATA[";
...
修改    ：  leichen 1503  2009-12-27
*/
bool TiXmlDeclaration::ToXMLText( TIXML_STRING& strBuffer )
{
    strBuffer += "<?xml ";
...
修改    ：  leichen 1503  2009-12-27
*/
bool TiXmlUnknown::ToXMLText( TIXML_STRING& strBuffer )
{
    strBuffer += "<";
    strBuffer += value;
    strBuffer += ">";
