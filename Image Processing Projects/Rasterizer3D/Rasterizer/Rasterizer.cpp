...
BEGIN_MESSAGE_MAP(CRasterizerApp, CWinAppEx)
...
// CRasterizerApp customization load/save methods

void CRasterizerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CRasterizerApp::LoadCustomState()
{
}

void CRasterizerApp::SaveCustomState()
{
}
