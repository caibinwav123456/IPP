...
{
	// TODO: Add your message handler code here and/or call default
	static Vec2 posDetM[50][MOUTH_GRID_N];
		...
		if(m_bShowGrid)
		{
			...
			for(int i=0;i<MOUTH_GRID_N;i++)
			{
				...
				else
				{
					...
					m_bFit|=(vcrit.length()>10);//(vdiff[i].length()>MIN_ITER_CRIT);
					//m_bFit|=(fitval[i]<fitval2);
					if(vcrit.length()<=3&&m_nTime>=50)
					{
						int o=0;
						o++;
					}
