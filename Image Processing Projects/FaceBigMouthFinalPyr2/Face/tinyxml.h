...
public:
	...
	*/
    virtual bool ToXMLText( TIXML_STRING& strBuffer) = 0;
...
public:
	...
	*/
    ...
    virtual bool ToXMLText( TIXML_STRING& strBuffer)
    {
        return true;
    }
...
public:
	...
	*/
	//modify by fangchun 20100226, if there is no text,return "", not NULL.
	const char* GetText() const;

	//added by fangchun 20100226 
	/*
	This is a convenient method for setting the text of simple contained text:
	@verbatim
		<foo>*</foo>   //* can be empty
		fooElement->SetText("chunpi");
	@endverbatim
	...
	*/
	...
	void SetText(const char* strTxt);
